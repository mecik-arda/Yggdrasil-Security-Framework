        ...
        function cancelUpdates() {
            if(updateContentDiv) {
                updateContentDiv.innerHTML = "<span style='color: #a3be8c;'>[ UPDATE nullLED. THE ROOTS REMAIN UNTOUCHED. ]</span>";
            }
            document.getElementById('status-display').innerText = ">> OPERATION nullED.";
        }
        ...
        function closeModal() {
            ...
            document.getElementById('status-display').innerText = ">> RITUAL nullED.";
        }
